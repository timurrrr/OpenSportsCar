...
Hyundai N cars |         | Tier 3 |     | Only a handful of people figured out how to log data, and it requires taking off multiple interior trim panels and splicing wires in the Body Control Module harness. There might be a better way.
